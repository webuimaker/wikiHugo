...
item: 
smallItem: 
 - title: "Deploying Kubernetes to AWS using Kops - Codefresh"
   summary: "codefresh.io"
   linkText: ""
   linkUrl: "https://codefresh.io/kubernetes-tutorial/tutorial-deploying-kubernetes-to-aws-using-kops/"
   openNewWindow: 
 ...
 - title: "Installing Kubernetes on AWS with Kops"
   ...
   linkText: ""
   linkUrl: "https://kubernetes.io/docs/getting-started-guides/kops/"
   openNewWindow: 
