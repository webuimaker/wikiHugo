...
smallItem: 
 - title: "Kubernetes on Ubuntu"
   ...
   linkText: ""
   linkUrl: "https://kubernetes.io/docs/getting-started-guides/ubuntu/"
   openNewWindow: false
...
---<ul class="list-wrapper link-section conf-macro output-block" data-hasbody="true" data-macro-name="list-wrapper">
