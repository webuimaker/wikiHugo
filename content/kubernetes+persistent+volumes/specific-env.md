...
item:
smallItem: 
 - title: "How to Add Persistent Storage to Your Kubernetes Apps Using Azure Disk"
   summary: "itnext.io"
   linkText: ""
   linkUrl: "https://itnext.io/how-to-add-persistent-storage-to-your-kubernetes-apps-using-azure-disk-5eb081c1a31"
   openNewWindow: 
 ...
 - title: "Kubernetes Storage on IBM Cloud"
   summary: "console.bluemix.net"
   linkText: ""
   linkUrl: "https://console.bluemix.net/docs/containers/cs_storage_basics.html"
   openNewWindow: 
